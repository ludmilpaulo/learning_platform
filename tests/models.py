...
class Question(models.Model):
    ...
    correct_answer = models.CharField(max_length=1, blank=True, null=True)  # A, B, C, or D for MCQ
...
class Answer(models.Model):
    ...
    selected_option = models.CharField(max_length=1, blank=True, null=True)  # A, B, C, D for MCQ
