...
class TutorProfile(BaseProfile):
    ...
    experience_years = models.IntegerField(null=True, blank=True)  # Years of experience as a tutor
    subjects = models.ManyToManyField(Subject, blank=True)  # Subjects the tutor can teach
    enrolled_courses = models.ManyToManyField(Course, blank=True)
    hourly_rate = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)  # Tutor's hourly rate
    is_active = models.BooleanField(default=True)  # Whether the tutor is actively teaching
